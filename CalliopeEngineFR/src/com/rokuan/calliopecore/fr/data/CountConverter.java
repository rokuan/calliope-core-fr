...
public class CountConverter {
	...
	public static final String NUMERICAL_POSITION_REGEX = "(\\d+(�|e)me$)|(\\d+e$)";
	...
	private static final WordPattern SINGLE_ITEM_PATTERN = WordPattern.sequence(
			...
			WordPattern.optional(FRWordPattern.simpleWord("num�ro(s?)")), 
			FRWordPattern.simpleWord(WordType.NUMBER));
	...
	public static boolean isAPosition(String posStr){
		if(posStr.equals("premier") || posStr.equals("premiers") || posStr.equals("premi�re") || posStr.equals("premi�res")
				|| posStr.equals("1er") || posStr.equals("1�re") || posStr.equals("1ere")
				|| posStr.equals("dernier") || posStr.equals("derniers") || posStr.equals("derni�re") || posStr.equals("derni�res")){
			return true;
		}
